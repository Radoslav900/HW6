...
public class MainMethod {
    public static void main(String[] args) {
        ...
        Numbers.sum(Numbers.averageValue(100,13),Numbers.averageValue(30,40));

        System.out.println("--------------------------");

        Numbers.averageValue(24,104);
        Numbers.sum(Numbers.averageValue(2,-5),Numbers.averageValue(-30,40));
